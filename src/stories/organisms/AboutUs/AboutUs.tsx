...
const AboutUs = () => {
  return (
    <Box sx={homeStyles.aboutUsContainer}>
      <Grid container spacing={10} sx={homeStyles.gridContainer}>
        <Grid item xs={12} md={5}>
          <img src={bestTeams} alt="My Team" style={homeStyles.largeImage} />
        </Grid>
        
        <Grid item xs={12} md={6}>
          <Typography variant="h4" fontWeight={700} sx={homeStyles.title}>
            We build, We revive
          </Typography>
